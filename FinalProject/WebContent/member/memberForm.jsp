...
<form action="MemberAddServlet" >
	<table>
		...
		<tr>
			...
			<td><input type="password" name="passwd" id="passwd2">&nbsp;&nbsp;
			<span id="pwresult"></span><br></td>
		</tr>
		<tr>
			<th>비밀번호확인
			</th>
...
<script type="text/javascript">
	$(document).ready(function() {
		...
		$("#passwd").on("keyup", function(event) {		
			$("#pwresult").removeClass("red");
			var passwd = $("#passwd").val();
			var passwd2 = $("#passwd2").val();
			if(passwd==passwd2){
				$("#pwresult").text("같습니다").addClass("blue");				
			}else{
				$("#pwresult").text("같지않습니다").addClass("red");
			}
